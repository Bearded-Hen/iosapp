...
- (double)getAverageWithDataSetLabel:(NSString * __nonnull)dataSetLabel;
...
/// :param: horizontal
/// :param: vertical
- (void)drawHighlightLinesWithContext:(CGContextRef __nonnull)context points:(CGPoint const * __null_unspecified)points horizontal:(BOOL)horizontal vertical:(BOOL)vertical;
@end
...
@property (nonatomic) CGFloat yOffset;
@property (nonatomic, copy) NSArray * __nonnull calculatedLabelBreakPoints;
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (SWIFT_NULLABILITY(nonnull) instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (SWIFT_NULLABILITY(nonnull) instancetype)initWithValue:(double)value dataSetIndex:(NSInteger)dataSetIndex dataSet:(ChartDataSet * __nonnull)dataSet OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, copy) NSArray * __nonnull subRenderers;
- (LineChartData * __null_unspecified)lineChartRendererData:(LineChartRenderer * __nonnull)renderer;
- (ChartTransformer * __null_unspecified)lineChartRenderer:(LineChartRenderer * __nonnull)renderer transformerForAxis:(enum AxisDependency)which;
- (id <ChartFillFormatter> __nonnull)lineChartRendererFillFormatter:(LineChartRenderer * __nonnull)renderer;
- (NSNumberFormatter * __null_unspecified)lineChartDefaultRendererValueFormatter:(LineChartRenderer * __nonnull)renderer;
...
- (NSArray * __nonnull)getSelectionDetailsAtIndex:(NSInteger)xIndex;
